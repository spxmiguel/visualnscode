...
addEventListener('mousemove',event=>{if(!selecting)return;clear();last=event.target;if(last instanceof HTMLElement){last.dataset.vnsOutline=last.style.outline;last.style.outline='2px solid #dd844e'}},true);
